...
/****** */
const token = "6tFXGFQldykEVe8DY6ZnsMwIPlAfigMYhopzkhqCXFI";
...
var PK5Message = "ไม่มีอะไรอัพเดทครับ"
...
{CoilId: 123 , Coilname: "Cutting Line(New) ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 124 , Coilname: "Cutting Line(New) ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 125 , Coilname: "Cutting Line(New) ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 126 , Coilname: "ห้องคัดแยกเศษ(New) ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 127 , Coilname: "เครื่องทำน้ำแข็ง no.1 ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 128 , Coilname: "เครื่องทำน้ำแข็ง no.2 ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 129 , Coilname: "เครื่องทำน้ำแข็ง no.3 ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"},
{CoilId: 130 , Coilname: "เครื่องทำน้ำแข็ง no.4 ", type: "คอยด์แอมโมเนีย",Status: "NG",SV: 0 ,PV1: 0 ,PV2: 0 ,Fan: "NG",Comp: "NG",Def: "NG",Ven: "NG",Remark: "NG"}  
]
...
var PK5Codetable = [ 
  ...
  {ID: 9 , PK5CommandOrder: "เช็คคอยด์",CommandCode: "03"},
  ...
  {ID: 13 , PK5CommandOrder: "ยกเลิกDefคอยด์",CommandCode: "06"},
  {ID: 14 , PK5CommandOrder: "StopIMC",CommandCode: "13"},
  {ID: 15 , PK5CommandOrder: "StartIMC",CommandCode: "42"},
  {ID: 16 , PK5CommandOrder: "CLIMC",CommandCode: "41"},
  {ID: 17 , PK5CommandOrder: "RunIMC",CommandCode: "43"},
  {ID: 18 , PK5CommandOrder: "เปิดBlower",CommandCode: "44"},
  {ID: 19 , PK5CommandOrder: "ปิดBlower",CommandCode: "44"},
  {ID: 20 , PK5CommandOrder: "เปิดBlowerเติมอากาศ",CommandCode: "44"},
  {ID: 21 , PK5CommandOrder: "ปิดBlowerเติมอากาศ",CommandCode: "44"},
  {ID: 22 , PK5CommandOrder: "เปิดBlowerดูดอากาศ",CommandCode: "44"},
  {ID: 23 , PK5CommandOrder: "ปิดBlowerดูดอากาศ",CommandCode: "44"}
  ]
//***** */
var day;
switch (new Date().getDay()) {
    ...
    case 2:
        ...
        break;
    case 3:
        day = "สวัสดีวันพุธ มีอะไรให้ผมรับใช้ครับ แจ้งชื่อหน่วยงานมาได้เลยครับ";
        break;
    case 4:
        day = "สวัสดีวันพฤหัสบดี ให้ผมช่วยอะไรได้บ้าง หน่วยงานไหนครับ?";
        break;
    case 5:
...
if(PK5CommandCode=="13"||PK5CommandCode=="41"||PK5CommandCode=="42"||PK5CommandCode=="43"){
  if(PK5coilId==1){PK5coilId=127}
  if(PK5coilId==2){PK5coilId=128}
  if(PK5coilId==3){PK5coilId=129}
  if(PK5coilId==4){PK5coilId=130}
}
switch (req.body.queryResult.parameters.PK5Command) {
  case "จาวิส":
      ...
      break;  
  case "?":   
  if(PK5Message !== "ไม่มีอะไรอัพเดทครับ"){

    speech = " "
    speech += PK5Message
    /**** */
    options.form.message = speech;
    //console.log('Alert Coundown');
    request(options);
    /**** */
    PK5Message = "ไม่มีอะไรอัพเดทครับ"
  }else{
    speech = " "
    speech += "ไม่มีอะไรอัพเดทครับ"
  }
  ...
  case "ตั้งอุณหภูมิห้อง":
      PK5SetTemp = req.body.queryResult.parameters.PK5Settemp * 10
  ...
  case "ยกเลิกDefคอยด์":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      PK5CommandOrder = "ยกเลิกละลายน้ำแข็ง"
      Singlecoil(PK5coilId)
      break;  
  case "StopIMC":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      PK5CommandOrder = "Stop"
      Singlecoil(PK5coilId)
      break;
  case "StartIMC":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      PK5CommandOrder = "Start"
      Singlecoil(PK5coilId)
      break;
  case "CLIMC":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      PK5CommandOrder = "Clearning"
      Singlecoil(PK5coilId)
      break;    
  case "RunIMC":
      //PK5coilId = req.body.queryResult.parameters.Coilno
  ...
  case "เปิดBlower":
      ...
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/08;44/127/01/10"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ เปิด BlowerเติมอากาศและBlowerดูดอากาศ เรียบร้อยครับ"
      break;     
  case "ปิดBlower":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/09;44/127/01/11"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ ปิด BlowerเติมอากาศและBlowerดูดอากาศ เรียบร้อยครับ"
      break; 
  case "เปิดBlowerเติมอากาศ":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/08"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ เปิด Blowerเติมอากาศ เรียบร้อยครับ"
      break;  
  case "ปิดBlowerเติมอากาศ":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/09"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ ปิด Blowerเติมอากาศ เรียบร้อยครับ"
      break;      
  case "เปิดBlowerดูดอากาศ":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/10"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ เปิด Blowerดูดอากาศ เรียบร้อยครับ"
      break;  
  case "ปิดBlowerดูดอากาศ":
      //PK5coilId = req.body.queryResult.parameters.Coilno
      //PK5CommandOrder = "Run"
      //Singlecoil(PK5coilId) 
      PK5Code = "44/127/01/11"
      microgear.chat('PK5', PK5Code)
      speech = "ดำเนินการ ปิด Blowerดูดอากาศ เรียบร้อยครับ"
      break;          
  default:
